...
### Phase 1: Jacobian Implementation Fix 🔄 IN PROGRESS
- [x] Compare QIG analytical, legacy, and finite difference Jacobian methods
- [ ] Identify which Jacobian implementation is mathematically correct
- [ ] Fix analytical Jacobian formulas in `exp_family.jacobian()`
- [ ] Update test expectations to match correct implementation
- [ ] Verify fix resolves test failures
