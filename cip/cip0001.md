...
- [ ] Agree on final package/module naming (`quantum_game` or alternative).
- [ ] Move core logic into package modules and keep legacy wrappers as needed.
- [ ] Refactor analysis/experiment scripts to use the new API.
