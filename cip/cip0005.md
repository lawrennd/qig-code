...
│   │   ├── matrix_exponential_families.rst
...
2. **Create API Reference**:
   ...
   - `api/exponential_family.rst`: MatrixExponentialFamily class
...
3. **Add Theory Section**:
   - Explain matrix exponential families
...
- [x] Phase 2: Content migration ✅ **MOSTLY COMPLETED**
  - [x] Migrate existing docs (TESTING.md, CONTRIBUTING.md, notebook docs)
  - [x] Converted NOTEBOOK_OUTPUT_FILTERING.md to RST
  - [x] Removed obsolete NOTEBOOK_TEST_FIXES.md (info already in TESTING.md)
  - [x] Updated quickstart to use correct API (solve_constrained_maxent)
  - [x] Added MIT License text to contributing.rst
  - [ ] Integrate CIP-0004 tolerance documentation (deferred to backlog: `2025-12-01_cip0004-documentation-completion.md`)
  - [x] Create API reference pages (core, exponential_family, dynamics, pair_operators, duhamel, analysis)
  - [~] Write theory section (stub files in place, can be expanded incrementally)
- [x] Phase 3: Read the Docs integration ✅ **COMPLETED (except manual RTD setup)**
  - [x] Create .readthedocs.yaml (configured for Python 3.11, Ubuntu 22.04)
  - [x] Create docs/requirements.txt (minimal deps for documentation build)
  - [x] Connect repository to Read the Docs (requires manual setup at readthedocs.org)
  - [x] Verify builds work (after RTD connection)
