...
**Mitigation**:
- Use perturbative expansion around maximally mixed state
- Work in regime where ρ = I/d + εX with small ε
- Alternatively: Use series expansion H ≈ log(d) - (1/2)Tr(X²) + ...
- Reference: Petz's perturbation theory for quantum entropy
...
**Mitigation**:
- Use SymPy's simplify, factor, cancel aggressively
- Apply domain-specific simplifications (e.g., use det(G) > 0)
- Break computation into smaller symbolic pieces
- Use common subexpression elimination
- If too complex: focus on special cases (symmetric states, small perturbations)

### Challenge 3: Third Derivatives

**Problem**: Third derivatives ∂³ψ/∂θ_a∂θ_b∂θ_c needed for ∇ν, expensive to compute.

**Mitigation**:
- Exploit Lie algebra: structure constants may create cancellations
- Compute only non-zero components (sparsity from structure)
- Use automatic differentiation for numerical validation
- Consider: maybe third derivatives simplify significantly for Lie basis vs 
  general basis

### Challenge 4: Validation at Pure State Boundary

**Problem**: Near pure states (θ → ∞), entropy gradients diverge, numerics unstable.

**Mitigation**:
- Test only in interior of state space (ε-regularized states)
- Document valid range of formulas
- Match validation strategy to quantum-generic-decomposition.tex (uses ε ∼ 1e-6)
...
- [ ] Create `qig/symbolic/__init__.py`
- [ ] Symbolic Gell-Mann matrices
- [ ] Symbolic structure constants
- [ ] Single-qutrit symbolic ρ
- [ ] Single-qutrit symbolic entropy

### Phase 2: Single-Qutrit Analysis
- [ ] Symbolic Fisher metric G
- [ ] Symbolic entropy gradient
- [ ] Document simplifications
- [ ] Validation tests pass

### Phase 3: Two-Qutrit Constraint Geometry
- [ ] Symbolic two-qutrit ρ
- [ ] Marginal entropies h₁, h₂
- [ ] Constraint gradient a
- [ ] Lagrange multiplier ν
- [ ] Gradient ∇ν (challenging!)

### Phase 4: Antisymmetric Part
- [ ] Assemble A = (1/2)[a⊗(∇ν)ᵀ - (∇ν)⊗aᵀ]
- [ ] Simplify expressions
- [ ] Verify block structure
- [ ] Validation tests pass (100 states, tol < 1e-12)

### Phase 5: Symmetric Part
...
- [ ] Create `symmetric_part_analytical_qutrit()`
- [ ] Add to `qig.analytic` module
- [ ] Performance benchmarking

### Phase 7: Testing
- [ ] Unit tests for symbolic module
- [ ] Validation tests against numerics (100+ states)
...
- [ ] API documentation with LaTeX formulas
- [ ] Technical documentation explaining approach
- [ ] Usage examples
- [ ] Jupyter notebook demonstration

### Phase 9: Multi-Pair Extension
