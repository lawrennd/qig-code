...
### Phase 3: Constraint Geometry ✅ COMPLETE  
- [x] Marginal entropies h₁, h₂ via partial trace
- [x] Constraint gradient a = ∇(h₁ + h₂)
- [x] **KEY RESULT**: Structural identity Gθ = -a is BROKEN for su(9) pair basis
- [x] Lagrange multiplier ν = (aᵀGθ)/(aᵀa)
- [x] **KEY RESULT**: ν ≠ -1 (complex rational function of θ)
- [x] Gradient ∇ν (quotient rule, cached)
- [x] **KEY RESULT**: ∇ν ≠ 0

### Phase 4: Antisymmetric Part ✅ COMPLETE
- [x] Assemble A = (1/2)[a⊗(∇ν)ᵀ - (∇ν)⊗aᵀ]
- [x] **KEY RESULT**: A ≠ 0! Hamiltonian dynamics exist!
- [x] Validated: ratio(numerical/symbolic) = 1.000
- [x] Expressions exported to `qig/symbolic/results/symbolic_expressions_4params.py`

### Phase 4b: LME EXACT Computation ✅ COMPLETE (BREAKTHROUGH!)
...
- [x] **KEY RESULT**: EXACT exp(K) to machine precision (~10⁻¹⁵)
- [x] **NO TAYLOR APPROXIMATION NEEDED** for LME dynamics!
...
### Key Files
- `qig/symbolic/lme_exact.py` - **EXACT exp(K) via block decomposition** (RECOMMENDED)
...
- `qig/symbolic/su9_pair.py` - general su(9) symbolic computation (Taylor-based)
