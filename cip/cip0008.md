...
- [ ] `product_of_bell_states` with `bell_indices` (deferred)
- [ ] `fisher_information_product` with block structure (deferred)
- [ ] Optimised block-diagonal computation for product σ (deferred)
