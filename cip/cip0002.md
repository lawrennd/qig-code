...
|--------|-----------|--------------|--------|
| `inaccessible_game_quantum.py` | ✓ | `QuantumExponentialFamily(n_sites, d)` | ❌ LOCAL |
| `advanced_analysis.py` | ✓ | `QuantumExponentialFamily(n_sites, d)` | ❌ LOCAL |
| `validate_qutrit_optimality.py` | ✓ | `QuantumExponentialFamily(n_sites, d)` | ❌ LOCAL |
