...
- `nbstripout documentation <https://github.com/kynan/nbstripout>`_
- `Git filters documentation <https://git-scm.com/book/en/v2/Customizing-Git-Git-Attributes>`_
