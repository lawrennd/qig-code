...
Topics:
- Scientifically-derived tolerance categories
- Categories A-F (machine precision to physical validation)
- Using the tolerance framework
...
Topics:
- Notebook output filtering (nbstripout)
- Notebook test fixes
- Smoke tests vs full execution
- Example notebooks
